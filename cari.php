...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  if($insertSQL) {
	  echo "<script type='text/javascript'>alert('Data Berhasil Disimpan!');location.href=\"alldata.php\";</script>";
	}
}
...
<form id="form2" name="form2" method="get" action="">
  <table width="95%" border="0" align="center" cellpadding="4" cellspacing="4">
    <tr>
      <td width="39%" align="right"><label for="carinama">Cari Nama :</label></td>
      <td width="70%"><input type="text" name="carinama" id="carinama" />        <input type="submit" name="cari" id="cari" value="Cari" /><input type="button" value="Reset" onclick="window.location='cari.php'"/></td>
    </tr>
  </table>
</form>
  <p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<?php if ($totalRows_cri > 0) { // Show if recordset not empty ?>
<div class="table-container">
  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="40" height="30" bgcolor="#006699"><div align="center">No</div></td>
      <td width="100" height="30" bgcolor="#006699"><div align="center">Nama</div></td>
      <td width="110" height="30" bgcolor="#006699"><div align="center">NPM</div></td>
      <td width="115" height="30" bgcolor="#006699"><div align="center">Kelas</div></td>
      <td width="96" bgcolor="#006699"><div align="center">Jenis Kelamin</div></td>
      <td width="106" bgcolor="#006699"><div align="center">Telpon</div></td>
      <td width="100" height="30" align="center" bgcolor="#006699"><div align="center">Email</div></td>
      <td width="150" height="30" align="center" bgcolor="#006699"><div align="center">Alamat</div></td>
      <td width="100" align="center" bgcolor="#006699"><div align="center">Jumlah Point</div></td>
      <td colspan="2" bgcolor="#006699"><div align="center">Action</div></td>
    </tr>
    <?php $nocari=1; do { ?>
      <tr>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $nocari; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $row_cri['nama']; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $row_cri['npm']; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $row_cri['kelas']; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $row_cri['jk']; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $row_cri['telp']; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $row_cri['email']; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo $row_cri['alamat']; ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center"><?php echo 'Rp. ' . number_format($row_cri['jumlah'], 0, ',', '.') .',-'; ?></div></td>
        <td width="50" bgcolor="#FFFFFF"><div align="center"><a href="edit.php?farida=<?php echo $row_cri['id_mhs']; ?>">Edit</a></div></td>
        <td width="50" bgcolor="#FFFFFF"><div align="center"><a href="hapus.php?farida=<?php echo $row_cri['id_mhs']; ?>">Hapus</a></div></td>
      </tr>
      <?php $nocari++; } while ($row_cri = mysql_fetch_assoc($cri)); ?>
  </table>
  </div>
