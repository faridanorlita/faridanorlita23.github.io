...
#wrapper #page-wrapper #page-inner .row .col-md-12 h3 marquee {
	font-size: 18px;
}
</style>
                  ...
                  <p>
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                             <strong>Selamat Anda Berhasil Login! </strong> Selamat Datang &quot;<?php echo $_SESSION['nm_admin'] ?>&quot;
                        </div>
                       
                       <h3><marquee>Prodi Sistem Informasi Fakultas Teknologi Informasi Uniska Banjarmasin 2018</marquee></h3>  
